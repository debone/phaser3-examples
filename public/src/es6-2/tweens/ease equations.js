class Example extends Phaser.Scene {
    ...
    create() {
        ...
        const markers = this.add.group({ key: 'bar', repeat: 27, setXY: { x: 196, y: 32, stepY }, setAlpha: { value: 0.3 } });

        const images = this.add.group({ key: 'bar', repeat: 27, setXY: { x: 196, y: 32, stepY }});
