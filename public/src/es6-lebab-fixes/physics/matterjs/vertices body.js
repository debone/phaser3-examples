class Example extends Phaser.Scene {
    create() {
        ...
        {
            let poly = this.add.polygon(400, 300, arrow, 0x0000ff, 0.2);
        ...
        {
            let poly = this.add.polygon(400, 100, chevron, 0xff0000, 0.2);
        ...
        {
            let poly = this.add.polygon(600, 400, star, 0x00ff00, 0.2);
